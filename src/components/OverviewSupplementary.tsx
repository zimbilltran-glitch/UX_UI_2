  ...
  return (
    <div className="space-y-6 mt-8 font-sans">
      ...
      <div className="surface-card p-6">
        <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Key Metrics</h3>
      ...
      <div className="surface-card p-6">
        <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-24">P/E Valuation</h3>
        ...
        <div className="relative w-full mb-16">
          ...
          {/* Current P/E Marker */}
          <div className="absolute top-1/2 left-[43%] transform -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-white border-2 border-gray-900 rounded-full shadow-md z-10"></div>
          
          {/* Current P/E Tooltip */}
          <div className="absolute top-[-70px] left-[43%] transform -translate-x-1/2 flex flex-col items-center z-20">
            <div className="bg-white border border-gray-200 rounded-lg px-4 py-2 flex flex-col items-center shadow-lg">
              <span className="text-[10px] text-gray-500 font-bold tracking-wider mb-1">CURRENT P/E</span>
              <span className="text-gray-900 font-bold text-lg leading-none">8.6x</span>
            </div>
          ...
          <div className="absolute top-[25px] left-[60%] transform -translate-x-1/2 flex flex-col items-center whitespace-nowrap">
            <span className="text-[10px] text-gray-500 font-bold tracking-wider mb-1">INDUSTRY P/E</span>
            <span className="text-emerald-600 font-bold text-lg leading-none">12.0x</span>
          </div>

          {/* Undervalued Pill */}
          <div className="absolute top-[-45px] left-[60%] transform -translate-x-1/2 whitespace-nowrap z-20">
            <div className="px-3 py-1.5 rounded-full border border-emerald-200 bg-emerald-50 text-emerald-700 text-xs font-bold flex items-center shadow-sm">
      ...
      <div className="surface-card p-6">
        <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-6">Banking Operations</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-6">
          <div className="flex justify-between items-center border-b border-gray-100 pb-3">
            <span className="text-gray-500 text-sm font-medium">NIM (Net Interest Margin)</span>
            <span className="text-gray-900 font-bold">12.78%</span>
          </div>
          <div className="flex justify-between items-center border-b border-gray-100 pb-3">
            <span className="text-gray-500 text-sm font-medium">Total Customer Deposits</span>
            <span className="text-gray-900 font-bold">921T VND</span>
          </div>
          <div className="flex justify-between items-center border-b border-gray-100 pb-3">
            <span className="text-gray-500 text-sm font-medium">Total Customer Loans</span>
            <span className="text-gray-900 font-bold">1,071T VND</span>
          </div>
          <div className="flex justify-between items-center border-b border-gray-100 pb-3">
            <span className="text-gray-500 text-sm font-medium">LDR (Loan-to-Deposit Ratio)</span>
            <span className="text-orange-600 font-bold">116.2%</span>
          </div>
          <div className="flex justify-between items-center border-b border-gray-100 pb-3">
            <span className="text-gray-500 text-sm font-medium">P/B</span>
            <span className="text-gray-900 font-bold">1.6x</span>
          </div>
          <div className="flex justify-between items-center border-b border-gray-100 pb-3">
            <span className="text-gray-500 text-sm font-medium">Dividend</span>
            <span className="text-gray-900 font-bold">0.0%</span>
          </div>
        </div>
      </div>
