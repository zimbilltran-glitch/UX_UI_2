      ...
      <div className="mb-12" id="section_1_1">
        ...
        <div className="surface-card p-8 relative overflow-hidden">
              ...
              <div className="absolute top-1/2 -translate-y-1/2" style={{ left: '35%' }}>
                ...
                <div className="absolute bottom-full mb-5 left-1/2 -translate-x-1/2 flex flex-col items-center">
                  <div className="bg-white border border-gray-200 px-4 py-2 rounded-lg shadow-lg whitespace-nowrap">
                    ...
                    <div className="text-gray-900 font-bold text-lg tracking-tight font-tabular">₫26,700.00</div>
                  </div>
                  {/* Pointer */}
              ...
              <div className="absolute top-1/2 -translate-y-1/2" style={{ left: '75%' }}>
                ...
                <div className="absolute top-full mt-6 left-1/2 -translate-x-1/2 flex flex-col items-center">
                  ...
                  <div className="whitespace-nowrap text-center">
                    ...
                    <div className="text-emerald-600 font-bold text-lg tracking-tight font-tabular">₫49,615.29</div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex justify-end space-x-2 mt-4 mb-8">
            <button className="btn-interactive px-3 py-1.5 bg-white hover:bg-gray-50 text-gray-700 rounded-lg text-sm border border-gray-200 transition-colors shadow-sm font-medium">
              Explore Narratives
            </button>
            <button className="btn-interactive flex items-center space-x-1 px-3 py-1.5 bg-white hover:bg-gray-50 text-gray-700 rounded-lg text-sm border border-gray-200 transition-colors shadow-sm font-medium">
            ...
            <button className="btn-interactive px-2 py-1.5 bg-white hover:bg-gray-50 text-gray-700 rounded-lg text-sm border border-gray-200 transition-colors shadow-sm font-medium">
