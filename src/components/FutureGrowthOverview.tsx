...
export const FutureGrowthOverview = () => {
  ...
  const renderUpdateIcon = (type: string) => {
    switch (type) {
      case 'positive':
        return <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center border border-emerald-200 flex-shrink-0"><TrendingUp className="w-4 h-4 text-emerald-600" /></div>;
      case 'negative':
        return <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center border border-red-200 flex-shrink-0"><TrendingDown className="w-4 h-4 text-red-600" /></div>;
      case 'neutral':
      default:
        return <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center border border-gray-200 flex-shrink-0"><BarChart2 className="w-4 h-4 text-gray-500" /></div>;
    }
  };

  return (
    <div className="mb-12 font-sans" id="section_2_0">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">2 Future Growth</h1>
        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            <div className="flex items-center space-x-2">
              <h2 className="text-xl font-bold text-gray-900">Future criteria checks {data.score}</h2>
            ...
            <button 
              ...
              className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center hover:bg-gray-100 transition-colors border border-gray-200"
            >
          ...
          {isExpanded && (
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:w-1/2 bg-gray-50 rounded-xl p-4 border border-gray-200">
                <h3 className="text-sm font-bold text-gray-900 mb-4 px-2">Future Score <span className="text-emerald-600">{data.score}</span></h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-lg">
          <h3 className="text-lg font-bold text-gray-900 mb-6">Key information</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center border-b border-gray-100 pb-3">
              ...
              <span className="text-xs font-medium text-emerald-700 bg-emerald-50 px-2 py-1 rounded border border-emerald-200">{data.key_metrics.analyst_coverage}</span>
            </div>
        ...
        {/* Recent Updates */}
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-lg flex flex-col relative">
          <h3 className="text-lg font-bold text-gray-900 mb-6">Recent future growth updates</h3>
          ...
          <div className="space-y-5 flex-1">
            {data.updates.map((update, index) => (
              <div key={index} className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-900 mb-1 leading-snug">{update.msg}</p>
          ...
          {showAllUpdates && (
            <div className="fixed inset-0 z-50 flex items-center justify-end bg-black/50 backdrop-blur-sm transition-opacity">
              <div className="w-full max-w-md h-full bg-white border-l border-gray-200 shadow-2xl flex flex-col transform transition-transform duration-300 translate-x-0">
                <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                  <h3 className="text-xl font-bold text-gray-900">Recent future growth updates</h3>
                  <button 
                ...
                <div className="p-6 overflow-y-auto flex-1 space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <p className="text-sm font-medium text-gray-900 mb-1 leading-snug">Price target increased to ₫32,705</p>
                  ...
                  <div className="flex items-start">
                    {renderUpdateIcon('positive')}
                    <div className="ml-4">
                      <p className="text-sm font-medium text-gray-900 mb-1 leading-snug">Price target increased to ₫27,315</p>
                  ...
                  <div className="flex items-start">
                    {renderUpdateIcon('positive')}
                    <div className="ml-4">
                      <p className="text-sm font-medium text-gray-900 mb-1 leading-snug">Price target increased to ₫26,058</p>
