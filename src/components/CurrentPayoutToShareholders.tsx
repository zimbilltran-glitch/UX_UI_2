...
const data = [
  { name: 'Paid as dividend', value: 7, color: '#3b82f6' },
  { name: 'Earnings retained', value: 93, color: '#4b5563' },
];

export const CurrentPayoutToShareholders = () => {
  return (
    <div className="mb-16" id="section_5_3">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-primary mb-2">5.3 Current Payout to Shareholders</h2>
      </div>
          ...
          <div className="w-full md:w-1/2">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-primary text-lg leading-relaxed">
                <span className="text-bearish font-medium">Earnings Coverage: </span>
                MBB is not paying a notable dividend for the VN market.
              </p>
            </div>
          </div>
        </div>
